  ...
  <div class="mock-panel">
    ...
    <div class="mock-toolbar">
      <div class="mock-toolbar-left">
        <button
          ...
          title="Import OpenAPI / Swagger JSON spec and generate mocks"
          @click="importOpenApi"
        >
          <svg
            viewBox="0 0 24 24"
    ...
    <div class="mock-groups">
      ...
      <div
        ...
        class="mock-group new-group-card"
      >
      ...
      >
        ...
        <div
          v-if="deleteGroupTarget?.id === group.id"
          class="mock-group-header mock-group-delete-confirm"
        >
        ...
        <div
          v-else
          :class="['mock-group-header', { disabled: !group.enabled }]"
        >
          <div class="mock-group-header-left">
            ...
            >
              <svg
                ...
                fill="none"
                stroke="currentColor"
                :style="{ transform: group.isOpened ? 'rotate(90deg)' : 'none' }"
              >
        ...
        <div
          v-if="group.isOpened"
          class="mock-group-rules"
        >
          <div
            v-for="rule in (group.rules || [])"
            :key="rule.id"
            :class="['mock-rule', { disabled: !rule.enabled }]"
          >
            <div class="mock-rule-main">
              ...
              <div class="mock-rule-info">
                <div class="mock-rule-name">
                  {{ rule.name || (typeof rule.urlPattern === 'string' ? rule.urlPattern : rule.urlPattern.source) }}
                </div>
                <div class="mock-rule-meta">
                  <span
                    v-if="rule.method"
                    class="mock-badge method-badge"
                  >{{ rule.method }}</span>
                  ...
                  <span
                    v-if="rule.response.delay"
                    class="mock-badge delay-badge"
                  >{{ rule.response.delay }}ms delay</span>
                </div>
              </div>
              <div class="mock-rule-actions">
                <button
                  class="btn-icon"
                  title="Edit"
                  @click="openEditRule(group.id, rule)"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
        ...
        <div
          v-if="showForm && editingGroupId === group.id"
          class="mock-form mock-form-inline"
        >
          ...
          <div class="mock-form-body">
            <div class="form-row">
              ...
              <input
                v-model="form.name"
                type="text"
                placeholder="e.g. Mock /api/users"
                class="form-input"
              >
            </div>
            ...
            <div class="form-row">
              ...
              <div class="mode-toggle">
                <button
                  :class="['mode-btn', { active: form.mode === 'mock' }]"
                  @click="form.mode = 'mock'"
                >
                  Mock
                </button>
                <button
                  :class="['mode-btn', { active: form.mode === 'transform' }]"
                  @click="form.mode = 'transform'"
                >
                  Transform
                </button>
              </div>
            ...
            <template v-if="form.mode === 'mock'">
              <div class="form-row two-col">
                ...
                <div>
                  ...
                  <input
                    v-model.number="form.response.delay"
                    type="number"
                    class="form-input"
                    min="0"
                    placeholder="0"
            ...
            <template v-else>
              <div class="form-row">
                ...
                <input
                  v-model.number="form.transform.status"
                  type="number"
                  class="form-input"
                  min="100"
                  max="599"
              ...
              <div class="form-row">
                ...
                <div class="kv-list">
                  <div
                    v-for="(h, i) in form.transform.headers"
                    :key="i"
                    class="kv-row"
                  >
                    <input
                    ...
                    <button
                      class="btn-icon danger"
                      @click="form.transform.headers.splice(i, 1)"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  <button
                    ...
                    @click="form.transform.headers.push({ key: '', value: '' })"
                  >
                    + Add header
                  </button>
                </div>
              ...
              <div class="form-row">
                ...
                <div class="kv-list">
                  <div
                    v-for="(f, i) in form.transform.bodyMerge"
                    :key="i"
                    class="kv-row"
                  >
                    <input
                    ...
                    <button
                      class="btn-icon danger"
                      @click="form.transform.bodyMerge.splice(i, 1)"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  <button
                    class="replay-add-header"
                    @click="form.transform.bodyMerge.push({ key: '', value: '' })"
                  >
                    + Add field
                  </button>
                </div>
              ...
              <div class="form-row">
                ...
                <div class="kv-list">
                  <div
                    v-for="(_, i) in form.transform.bodyDelete"
                    :key="i"
                    class="kv-row"
                  >
                    <input
                      v-model="form.transform.bodyDelete[i]"
                      class="form-input"
                      placeholder="Field name"
                    >
                    <button
                      class="btn-icon danger"
                      @click="form.transform.bodyDelete.splice(i, 1)"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  <button
                    class="replay-add-header"
                    @click="form.transform.bodyDelete.push('')"
                  >
                    + Add field
                  </button>
                </div>
          ...
          <div class="mock-form-conditions">
            ...
            <div class="conditions-group">
              <div class="conditions-group-title">
                Query params
              </div>
              <div class="kv-list">
                <div
                  v-for="(p, i) in form.conditions.queryParams"
                  :key="i"
                  class="kv-row"
                >
                  <input
                  ...
                  <button
                    class="btn-icon danger"
                    @click="form.conditions.queryParams.splice(i, 1)"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <button
                  class="replay-add-header"
                  @click="form.conditions.queryParams.push({ key: '', value: '' })"
                >
                  + Add param
                </button>
              </div>
            ...
            <div class="conditions-group">
              ...
              <div class="kv-list">
                <div
                  v-for="(h, i) in form.conditions.headers"
                  :key="i"
                  class="kv-row"
                >
                  <input
                  ...
                  <button
                    class="btn-icon danger"
                    @click="form.conditions.headers.splice(i, 1)"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <button
                  class="replay-add-header"
                  @click="form.conditions.headers.push({ key: '', value: '' })"
                >
                  + Add header
                </button>
              </div>
            ...
            <div class="conditions-group">
              <div class="conditions-group-title">
                Body fields <span class="form-hint">(top-level JSON, value supports JSON)</span>
              </div>
              <div class="kv-list">
                <div
                  v-for="(f, i) in form.conditions.bodyFields"
                  :key="i"
                  class="kv-row"
                >
                  <input
                  ...
                  <button
                    class="btn-icon danger"
                    @click="form.conditions.bodyFields.splice(i, 1)"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <button
                  class="replay-add-header"
                  @click="form.conditions.bodyFields.push({ key: '', value: '' })"
                >
                  + Add field
                </button>
              </div>
