  ...
  <div class="bp-panel">
    ...
    <div class="mock-toolbar">
      ...
      <span class="mock-title">
        ...
        <span
          v-if="active.length"
          class="bp-active-count"
        >{{ active.length }} paused</span>
      </span>
    </div>
    ...
    >
      <div class="form-row">
        ...
        <input
          v-model="formName"
          class="form-input"
          placeholder="e.g. Pause user requests"
    ...
    <div class="bp-rules">
      ...
      >
        ...
        <div
          ...
          class="bp-add-form bp-inline-form"
        >
          <div class="form-row">
            <label>Name <span class="form-hint">(optional)</span></label>
            <input
        ...
        >
          ...
          <button
            ...
            @click="dashboard.removeBreakpointRule(rule.id)"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
    ...
    <template v-if="active.length">
      ...
      >
        ...
        <div class="bp-card-fields">
          ...
          <label>Method</label>
          <input
            v-model="getEdit(bp.id, bp).method"
            class="form-input"
          ...
          <textarea
            v-model="getEdit(bp.id, bp).headersText"
            class="form-textarea bp-headers-area"
            rows="3"
            spellcheck="false"
          />
